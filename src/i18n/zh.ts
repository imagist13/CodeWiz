...
const zh: Record<TranslationKey, string> = {
  ...
  // ── Message list ────────────────────────────────────────────
  'messageList.claudeChat': 'CodeWiz 对话',
  'messageList.emptyDescription': '开始与 CodeWiz 对话。提问、获取代码帮助或探索想法。',
  ...
  // ── Settings: General ───────────────────────────────────────
  'settings.title': '设置',
  'settings.description': '管理 CodeWiz 和 Claude Code 设置',
  'settings.general': '通用',
  'settings.providers': '服务商',
  'settings.claudeCli': 'Claude Code',
  'settings.knowledge.title': '知识库',
  'settings.knowledge.description': '使用向量嵌入对工作区文档进行语义搜索',
  'settings.knowledge.noWorkspace': '请先配置助理工作区路径以启用知识库搜索。',
  'settings.knowledge.workspacePath': '工作区路径',
  'settings.knowledge.workspacePathDesc': '从此目录索引的文档将可用于语义搜索',
  'settings.knowledge.enable': '启用语义搜索',
  'settings.knowledge.enableDesc': '在助理工作区中提问时，自动检索相关文档',
  'settings.knowledge.embeddingProvider': 'Embedding 提供商',
  'settings.knowledge.embeddingProviderDesc': '用于生成文本嵌入的 AI 服务商',
  'settings.knowledge.useDefaultProvider': '使用默认服务商',
  'settings.knowledge.embeddingModel': 'Embedding 模型',
  'settings.knowledge.embeddingModelDesc': 'Embedding 模型决定准确率和维度',
  'settings.knowledge.threshold': '相关性阈值',
  'settings.knowledge.thresholdDesc': '仅注入相似度高于此值的结果',
  'settings.knowledge.maxResults': '最大结果数',
  'settings.knowledge.maxResultsDesc': '每次查询最多注入的文档片段数量',
  'settings.knowledge.indexStats': '索引统计',
  'settings.knowledge.loading': '加载中...',
  'settings.knowledge.notIndexed': '尚未索引 — 点击"重新索引"开始',
  'settings.knowledge.zeroChunks': '未找到文档，请确保工作区包含 .md 或 .txt 文件。',
  'settings.knowledge.chunksIndexed': '已索引片段',
  'settings.knowledge.embeddingDimension': '向量维度',
  'settings.knowledge.embeddingModelLabel': '模型',
  'settings.knowledge.lastIndexed': '上次索引',
  'settings.knowledge.indexSuccess': '索引完成',
  'settings.knowledge.indexing': '索引中...',
  'settings.knowledge.reindex': '重新索引工作区',
  'settings.knowledge.reindexHint': '增量索引 — 仅重新处理新增和变更的文件',
  ...
  'settings.errorReportingDesc': '帮助改进 CodeWiz：匿名上报错误信息，不包含对话内容和 API Key。更改后需重启应用才能完全生效。',
  ...
  'settings.appearanceDesc': '自定义 CodeWiz 的外观和风格',
  ...
  'cli.agentRuntimeDesc': '选择 CodeWiz 执行 Agent 任务的方式',
  ...
  'connection.gitInstallSuccess': 'Git 安装成功！请重启 CodeWiz。',
  ...
  'connection.upgradeSuccess': '升级成功！请重启 CodeWiz 以应用更新。',
  ...
  'update.readyToInstall': 'CodeWiz v{version} 已就绪 — 重启以完成更新',
  'update.installUpdate': '下载并安装',
  'update.later': '稍后',
  'update.rosettaWarning': 'CodeWiz 当前正通过 Rosetta 在这台 Apple Silicon Mac 上运行。安装 arm64 版本可获得更好的响应速度。',
  ...
  'feishu.quickCreateDesc': '自动创建飞书机器人并绑定到 CodeWiz，无需手动配置权限和事件',
  ...
  // ── Knowledge Base ─────────────────────────────────────────
  'chat.knowledgeSearch': '搜索知识库',
  'chat.knowledgeSearchPlaceholder': '搜索工作区文档...',
  'chat.knowledgeNoResults': '未找到结果',
  'chat.knowledgeSearchHint': '输入关键词搜索知识库',
  ...
  'mcp.enabled': '已启用',
  'mcp.disabled': '已禁用',
  'mcp.managerDesc': '开关控制 CodeWiz 注入的 MCP 服务。Claude Code 自身配置中的服务仍可能被 SDK 通过 settingSources 自动加载。',
  ...
  'cliTools.viewDocs': '查看 CodeWiz 官方文档',
  ...
  'setup.welcome.description': 'CodeWiz 是多模型 AI Agent 桌面客户端。连接任意 AI 服务商，通过 MCP 和 Skills 扩展能力，让你的助理学会你的工作方式。',
  ...
  'setup.provider.description': '配置 CodeWiz 连接 AI 模型的方式。',
  ...
  'dev.pr': 'PR 提交',
  'dev.confirmed': '已确认',
  'dev.confirmAndProceed': '确认并继续',
  'dev.answerAll': '请先回答所有问题',
  'dev.answersConfirmed': '已确认答案，继续下一步',
  'dev.techChoices': '技术选型',
  'dev.fileChanges': '文件变更清单',
  'dev.file': '文件',
  'dev.op': '操作',
  'dev.desc': '描述',
  'dev.implementationSteps': '实现步骤',
  'dev.risks': '风险评估',
  'dev.confirmPlan': '确认方案并继续',
  'dev.planConfirmed': '方案已确认，继续下一步',
  'dev.modifyFiles': '需要修改的文件',
  'dev.newFiles': '需要新增的文件',
  'dev.generatingCode': '正在生成代码...',
  'dev.writeResults': '写入结果',
  'dev.branch': '分支',
  'dev.commit': '提交信息',
  'dev.prDescription': 'PR 描述',
  'dev.stepConfirmed': '已确认，继续下一步',
  'dev.pass': '通过',
  'dev.fail': '失败',
  'dev.running': '进行中',
  'dev.gitCommands': 'Git 操作步骤',
  'dev.commitMessage': '提交信息',
  'dev.createBranch': '创建分支',
  'dev.stageFiles': '暂存文件',
  'dev.pushBranch': '推送分支',
};
