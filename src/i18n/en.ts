...
const en = {
  ...
  // ── Message list ────────────────────────────────────────────
  'messageList.claudeChat': 'CodeWiz Chat',
  'messageList.emptyDescription': 'Start a conversation with CodeWiz. Ask questions, get help with code, or explore ideas.',
  ...
  'settings.description': 'Manage CodeWiz and Claude Code settings',
  'settings.general': 'General',
  'settings.providers': 'Providers',
  'settings.claudeCli': 'Claude Code',
  'settings.knowledge.title': 'Knowledge',
  'settings.knowledge.description': 'Semantic search over your workspace documents using vector embeddings',
  'settings.knowledge.noWorkspace': 'Configure an Assistant Workspace path first to enable knowledge base search.',
  'settings.knowledge.workspacePath': 'Workspace Path',
  'settings.knowledge.workspacePathDesc': 'Documents indexed from this directory will be available for semantic search',
  'settings.knowledge.enable': 'Enable Semantic Search',
  'settings.knowledge.enableDesc': 'Automatically retrieve relevant documents when you ask questions in the Assistant Workspace',
  'settings.knowledge.embeddingProvider': 'Embedding Provider',
  'settings.knowledge.embeddingProviderDesc': 'AI provider used to generate text embeddings',
  'settings.knowledge.useDefaultProvider': 'Use default provider',
  'settings.knowledge.embeddingModel': 'Embedding Model',
  'settings.knowledge.embeddingModelDesc': 'Embedding model determines accuracy and dimension',
  'settings.knowledge.threshold': 'Relevance Threshold',
  'settings.knowledge.thresholdDesc': 'Only inject results with similarity above this value',
  'settings.knowledge.maxResults': 'Max Results',
  'settings.knowledge.maxResultsDesc': 'Maximum number of document chunks to inject per query',
  'settings.knowledge.indexStats': 'Index Statistics',
  'settings.knowledge.loading': 'Loading...',
  'settings.knowledge.notIndexed': 'Not indexed yet — click "Re-index" to start',
  'settings.knowledge.zeroChunks': 'No documents found. Make sure your workspace contains .md or .txt files.',
  'settings.knowledge.chunksIndexed': 'Chunks Indexed',
  'settings.knowledge.embeddingDimension': 'Dimension',
  'settings.knowledge.embeddingModelLabel': 'Model',
  'settings.knowledge.lastIndexed': 'Last Indexed',
  'settings.knowledge.indexSuccess': 'Indexing complete',
  'settings.knowledge.indexing': 'Indexing...',
  'settings.knowledge.reindex': 'Re-index Workspace',
  'settings.knowledge.reindexHint': 'Incremental — only new and changed files are re-embedded',
  'settings.codepilot': 'CodeWiz',
  ...
  'settings.errorReportingDesc': 'Help improve CodeWiz by anonymously reporting errors. No conversation content or API keys are included. Restart the app for the change to fully take effect.',
  ...
  'settings.appearanceDesc': 'Customize the look and feel of CodeWiz',
  ...
  'cli.agentRuntimeDesc': 'Choose how CodeWiz executes agent tasks',
  ...
  'connection.gitInstallSuccess': 'Git installed successfully! Please restart CodeWiz.',
  ...
  'connection.upgradeSuccess': 'Upgrade successful! Please restart CodeWiz to apply the update.',
  ...
  'update.readyToInstall': 'CodeWiz v{version} is ready — restart to update',
  'update.installUpdate': 'Download & Install',
  'update.later': 'Later',
  'update.rosettaWarning': 'CodeWiz is running through Rosetta on this Apple Silicon Mac. Install the arm64 build for better responsiveness.',
  ...
  'feishu.quickCreateDesc': 'Auto-create a Feishu bot and bind it to CodeWiz — no manual permission or event setup needed',
  ...
  // ── Knowledge Base ─────────────────────────────────────────
  'chat.knowledgeSearch': 'Search knowledge base',
  'chat.knowledgeSearchPlaceholder': 'Search your workspace documents...',
  'chat.knowledgeNoResults': 'No results found',
  'chat.knowledgeSearchHint': 'Type to search your knowledge base',
  ...
  'mcp.managerDesc': 'Toggle controls CodeWiz MCP injection. Servers in your Claude Code config may still be loaded by the SDK via its own settings sources.',
  ...
  'cliTools.viewDocs': 'View CodeWiz documentation',
  ...
  // ── Setup Center ──────────────────────────────────────────────
  'setup.title': 'Welcome to CodeWiz',
  ...
  'setup.welcome.description': 'CodeWiz is a multi-model AI agent desktop client. Connect any AI provider, extend with MCP & skills, and let your assistant learn your workflow.',

  // Setup: Claude Code card
  'setup.claude.title': 'Claude Code CLI (Optional)',
  'setup.claude.description': 'Install Claude Code CLI for full command-line capabilities. CodeWiz works without it via the AI SDK engine.',
  ...
  'setup.provider.description': 'Configure how CodeWiz connects to AI models.',
  ...
  'dev.plan': 'Plan',
  'dev.locate': 'Locate',
  'dev.generate': 'Generate',
  'dev.write': 'Write',
  'dev.verify': 'Verify',
  'dev.pr': 'PR',
  'dev.confirmed': 'Confirmed',
  'dev.confirmAndProceed': 'Confirm & Continue',
  'dev.answerAll': 'Answer all questions first',
  'dev.answersConfirmed': 'Answers confirmed, proceeding',
  'dev.techChoices': 'Tech Choices',
  'dev.fileChanges': 'File Changes',
  'dev.file': 'File',
  'dev.op': 'Op',
  'dev.desc': 'Description',
  'dev.implementationSteps': 'Implementation Steps',
  'dev.risks': 'Risk Assessment',
  'dev.confirmPlan': 'Confirm Plan & Continue',
  'dev.planConfirmed': 'Plan confirmed, proceeding',
  'dev.modifyFiles': 'Files to Modify',
  'dev.newFiles': 'New Files',
  'dev.generatingCode': 'Generating code...',
  'dev.writeResults': 'Write Results',
  'dev.branch': 'Branch',
  'dev.commit': 'Commit Message',
  'dev.prDescription': 'PR Description',
  'dev.stepConfirmed': 'Confirmed, proceeding to next step',
  'dev.pass': 'Pass',
  'dev.fail': 'Fail',
  'dev.running': 'Running',
  'dev.gitCommands': 'Git Commands',
  'dev.commitMessage': 'Commit Message',
  'dev.createBranch': 'Create Branch',
  'dev.stageFiles': 'Stage Files',
  'dev.pushBranch': 'Push Branch',
} as const;
