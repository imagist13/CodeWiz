...
function createTray(): void {
  ...
  tray.setToolTip('CodeWiz — Bridge Active');
...
function checkNativeModuleABI(): void {
  ...
  try {
    ...
    if (msg.includes('NODE_MODULE_VERSION')) {
      ...
      dialog.showErrorBox(
        'CodeWiz - Native Module ABI Mismatch',
 ...
 * uncommon in practice. 8 candidates handles up to 8 concurrent CodeWiz
